    ...
    */
    RGraph.Contextmenu = function (canvas, menuitems, e)
    {
        ...
        */
        ...
        div.style.WebkitBorderTopRightRadius = '5px';
        div.style.MozBorderRadiusTopright = '5px';
        ...
        */
        for (i=0; i<menuitems.length; ++i) {
            ...
            /**
            * Last menu item should have border radius set
            */
            if (i == 0) {
                menuitem.style.WebkitBorderTopRightRadius = '5px';
                menuitem.style.MozBorderRadiusTopright = '5px';
                menuitem.style.borderTopRightRadius = '5px';
            }
    ...
    RGraph.Zoom = function (e)
    {
        ...
        */
        ...
        if (obj.Get('chart.zoom.background')) {
            ...
            for (var i=1; i<=frames; ++i) {
                setTimeout("__zoomedbackground__.style.opacity = " + Number(i / frames), i * delay);
            }
        }
    }
