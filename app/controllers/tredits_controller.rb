         ...
         case  request_format
          when "[text/html]","text/html" then
            @html_request ="Y"
              ...
              @db_columns   =["trfiles.id","trfiles.file_completed_flag","trfiles.updated_at","concat(trfiles.subjectid,IF(trfiles.secondary_key IS NULL,'',concat(' ',trfiles.secondary_key)))","scan_procedures.codename"]
