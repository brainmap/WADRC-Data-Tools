	...
	class Jobs::Pet::PetscanNeuraceq < Petscan
		...
		def appropriate_T2?(filename)
		    if filename.include?('_T2_') and filename.end_with?(".nii")
		      if filename.include?('ORIG')
		        return true
		      elsif filename.include?('PU')
		        return true
		      elsif filename.include?('CUBE_T2')
		        return true
		      elsif filename.include?('CUBE_Flair') or filename.include?('CUBE_FLAIR')
		        return true
		      end
		    end
		    return false
