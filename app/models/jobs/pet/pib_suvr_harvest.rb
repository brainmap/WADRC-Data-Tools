                ...
                if !roi_file_name.blank? and !log_file_name.blank? and !product_file_name.blank?
                  ...
                  if log_file_data["multispectral file"]  > ""
                    ...
                    if v_processedimages.count <1
                      ...
                      v_processedimagesources = Processedimagessource.where("processedimage_id in (?) and source_image_id in (?) and source_image_type = 'processedimage'",v_processedimage.id,v_mri_processedimage_id)
                      if v_processedimagesources.count < 1 
                        v_processedimagesource = create_processed_image_source(path: log_file_data["original t1 MRI file"], processed_image_id:v_processedimage.id, source_id:v_mri_processedimage_id, source_type:'processedimage')
