class Trtype < ActiveRecord::Base
	...
	serialize :processedimagesfiletype_id   # need multiple processedimage type ids
	#has_and_belongs_to_many :users
  #attr_accessible :description, :parameters, :status_flag, :series_description_type_id, :action_name,:triggers_1   
  private
  def trtype_params
    params.require(:trtype).permit(:description, :parameters, :status_flag, :series_description_type_id, :action_name,:triggers_1,:processedimagesfiletype_id)
  end
end
