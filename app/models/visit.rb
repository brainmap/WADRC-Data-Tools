  ...
  def age_from_dicom_info
   ...
   return @age_info unless @age_info.blank?
    ...
    image_datasets.each do |dataset|
      if  dataset.dicom_taghash  
        tags = dataset.dicom_taghash      
        if @age_info[:age].blank? and !tags['0010,1010'].blank? and tags['0010,1010'] != '0010,1010' and tags['0010,1010'][:value] != 'XX' and tags['0010,0030'][:value] != '00/00/0000'
              @age_info[:age] = tags['0010,1010'][:value].blank? ? nil : tags['0010,1010'][:value].to_i  # age
         end
         if @age_info[:dob].blank? and !tags['0010,0030'].blank? and tags['0010,0030'] != '0010,0030' and tags['0010,0030'][:value] != 'XX' and tags['0010,0030'][:value] != '00/00/0000'
             # getting XX
