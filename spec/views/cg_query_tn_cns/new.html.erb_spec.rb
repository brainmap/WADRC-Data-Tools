...
describe "cg_query_tn_cns/new.html.erb" do
  before(:each) do
    assign(:cg_query_tn_cn, stub_model(CgQueryTnCn,
      :cg_query_tn_id => 1,
      :cg_tn_cn_id => "",
      :value_1 => "MyString",
      :value_2 => "MyString",
  ...
  it "renders new cg_query_tn_cn form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => cg_query_tn_cns_path, :method => "post" do
