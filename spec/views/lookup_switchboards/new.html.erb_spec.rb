...
describe "lookup_switchboards/new.html.erb" do
  before(:each) do
    assign(:lookup_switchboard, stub_model(LookupSwitchboard,
  ...
  it "renders new lookup_switchboard form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => lookup_switchboards_path, :method => "post" do
