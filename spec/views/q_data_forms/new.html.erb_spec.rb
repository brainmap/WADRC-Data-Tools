...
describe "q_data_forms/new.html.erb" do
  before(:each) do
    assign(:q_data_form, stub_model(QDataForm,
      :questionform_id => 1,
      :participant_id => 1,
      :visit_id => 1,
      :appointment_id => 1,
  ...
  it "renders new q_data_form form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => q_data_forms_path, :method => "post" do
